...
function removeItem(myGroceryList, itemToRemove) {
  if (!myGroceryList || !itemToRemove || !Array.isArray(myGroceryList)) {
    return [];
  }
...
function addItem(myGroceryList, itemToAdd) {
  if (!myGroceryList || !itemToAdd || !Array.isArray(myGroceryList)) {
    return [];
  }
...
var devMtnEmp = function(arr, obj) {
  arr.push(obj);
};
...
var leaveOfAbsence = function(arr, obj) {
